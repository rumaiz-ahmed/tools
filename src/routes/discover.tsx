...
const tools = [
  { icon: Calculator, name: "Calculator", description: "Perform basic and scientific calculations", category: "Productivity", href: "/tools/calculator" },
  { icon: Calendar, name: "Date Calculator", description: "Calculate dates, add or subtract days", category: "Time", href: "/tools/date-calculator" },
  { icon: Clock, name: "World Clock", description: "Check time zones around the world", category: "Time", href: "/tools/world-clock" },
  { icon: Type, name: "Text Tools", description: "Word counter, character counter, and more", category: "Text", href: "/tools/text-tools" },
  { icon: Palette, name: "Color Converter", description: "Convert between HEX, RGB, and HSL", category: "Developer", href: "/tools/color-converter" },
  { icon: Code, name: "JSON Formatter", description: "Format and validate JSON data", category: "Developer", href: "/tools/json-formatter" },
  { icon: Image, name: "Image Converter", description: "Convert images between formats", category: "Media", href: "/tools/image-converter" },
  { icon: FileText, name: "PDF Tools", description: "Merge, split, and compress PDFs", category: "Documents", href: "/tools/pdf-tools" },
  { icon: Link2, name: "URL Shortener", description: "Shorten and manage URLs", category: "Web", href: "/tools/url-shortener" },
  { icon: Wrench, name: "Unit Converter", description: "Convert length, weight, temperature and more", category: "Productivity", href: "/tools/unit-converter" },
]

const categories = ["All", "Productivity", "Time", "Text", "Developer", "Media", "Documents", "Web"]
    ...
    <div className="min-h-screen bg-white text-black">
        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex items-center gap-8">
              <Link to="/discover" className="text-sm font-medium text-black border-b-2 border-black pb-0.5">
                All Tools
              </Link>
              <a 
      ...
      <main className="pt-32 pb-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          {/* Subtitle */}
          <div className={`mt-6 transition-all duration-1000 delay-200 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          {/* Categories */}
          <div className={`mt-8 transition-all duration-1000 delay-400 ${mounted ? 'opacity-100' : 'opacity-0'}`}>
